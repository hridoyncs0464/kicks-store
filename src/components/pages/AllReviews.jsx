...
function injectGridStyles() {
  ...
  style.textContent = `
    ...
    @media (max-width: 1024px) {
      .kicks-reviews-grid { grid-template-columns: repeat(3, 1fr); }
    }
    @media (max-width: 768px) {
      .kicks-reviews-grid { grid-template-columns: repeat(2, 1fr); }
    }
    @media (max-width: 480px) {
      .kicks-reviews-grid { grid-template-columns: 1fr; }
    }
    .kicks-review-card {
      border-radius: 16px;
      overflow: hidden;
  ...
  return (
    <div className="kicks-review-card" style={{ minHeight: "280px" }}>
      <div style={{ padding: "14px", display: "flex", justifyContent: "space-between" }}>
        <div style={{ flex: 1 }}>
          <div className="review-skeleton" style={{ height: "14px", borderRadius: "6px", marginBottom: "8px", width: "60%" }} />
          <div className="review-skeleton" style={{ height: "12px", borderRadius: "6px", marginBottom: "8px", width: "80%" }} />
          <div className="review-skeleton" style={{ height: "12px", borderRadius: "6px", width: "40%" }} />
        </div>
        <div className="review-skeleton" style={{ width: "40px", height: "40px", borderRadius: "50%", marginLeft: "10px" }} />
      </div>
      <div className="review-skeleton" style={{ height: "160px" }} />
      <div style={{ padding: "10px 14px" }}>
        <div className="review-skeleton" style={{ height: "12px", borderRadius: "6px", width: "50%" }} />
      </div>
    </div>
  );
}
...
export default function AllReviews() {
  // ✅ uses the same hook + api.js as Reviews.jsx — no hardcoded fetch path
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
              <Link to="/" style={{ fontSize: "13px", color: "#6b7280", textDecoration: "none" }}>
                Home
              </Link>
              <span style={{ color: "#d1d5db" }}>›</span>
              <span style={{ fontSize: "13px", color: "#111827", fontWeight: "600" }}>Reviews</span>
            </div>
            <h1 style={{ margin: 0, fontSize: "28px", fontWeight: "800", color: "#111827", textTransform: "uppercase", letterSpacing: "-0.5px" }}>
              Customer Reviews
            </h1>
          </div>
          {!loading && !error && (
            <span style={{ background: "#eff6ff", color: "#3b5bdb", borderRadius: "999px", padding: "6px 16px", fontSize: "13px", fontWeight: "700" }}>
